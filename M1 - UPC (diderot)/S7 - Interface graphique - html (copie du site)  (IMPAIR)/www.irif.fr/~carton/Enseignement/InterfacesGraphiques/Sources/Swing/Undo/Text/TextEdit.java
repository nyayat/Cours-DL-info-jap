// -*- coding: utf-8 -*-
// Time-stamp: <TextEdit.java  21 nov 2019 17:34:10>
...
class TextEdit extends JFrame {
	...
	// La classe UndoManager implémente l'interface UndoableEditListener
	// On pourrai donc faire editor.getDocument().addUndoableEditListener(manager)
	// mais dans ce cas, l'activation des bouttons undoButton et redoButton n'est
	// pas mise à jour.
