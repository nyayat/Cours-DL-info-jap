...
/**
 * Modifiez votre solution de l'exercice précédent en utilisant des variables
 * de condition (via pthread_cond_wait) plutôt qu'une attente active.
 */
...
void barriere(barriere_t* barriere_struct) {
	...
	/* Cf : schéma simplifié d'utilisation de mutex et condition, cours 7 */
	 ...
	 * à tous les processus suspendu sur la condition */
...
/**
 * La solution de l'exercice précédent
 * Reponse : Bcp de CPU....
